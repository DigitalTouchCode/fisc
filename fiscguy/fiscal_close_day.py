...
def salebytax(counter):
    if counter.get('name') == "SALEBYTAX" and counter.get('tax_name').lower() == 'standard 15%':
        total_line_value += counter.get('value')

    if counter.get('name') == "SALEBYTAX" and counter.get('tax_name').lower() == 'exempt':
        total_line_value += counter.get('value')
